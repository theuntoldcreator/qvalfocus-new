...
import { FaFacebookF, FaTwitter, FaYoutube, FaLinkedinIn } from 'react-icons/fa'; // Added FaYoutube
      ...
      >
        ...
        <div className="flex justify-between items-center mb-8">
          <div className="flex flex-col">
            <Link to="/" className="flex items-center space-x-2" onClick={onClose}>
              ...
              <span className="text-xl font-bold text-slate-900 dark:text-white">Recruitment Agency</span>
            </Link>
        ...
        <div className="flex justify-center space-x-4 bg-avada-green-darker p-4 rounded-lg">
          ...
          <a href="#" target="_blank" rel="noopener noreferrer" className="text-white hover:text-avada-light-green transition-colors">
            <FaYoutube className="h-5 w-5" /> {/* Using FaYoutube for YouTube */}
          </a>
