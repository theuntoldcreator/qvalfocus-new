        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex h-20 items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              >
                <span className="flex items-center px-4 py-2 rounded-full bg-avada-yellow text-accent-foreground hover:bg-avada-blue hover:text-white transition-colors duration-200"> {/* Inner yellow "button" look, now with blue hover */}
