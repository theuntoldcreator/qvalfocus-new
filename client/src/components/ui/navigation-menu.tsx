...
const NavigationMenuItem = cva(
  "group relative flex items-center justify-center text-sm font-medium transition-colors hover:text-primary focus:text-primary data-[active]:text-primary data-[state=open]:text-primary"
)
