...
const heroImages = [
  "https://images.unsplash.com/photo-1557804506-669a67965da0?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80", // A person working on a laptop, with the focus on the right side
];
