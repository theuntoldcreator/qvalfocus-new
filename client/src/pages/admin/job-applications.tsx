...
import { ApplicantDetail } from "@/components/admin/applicant-detail"; // Import new detail component
...
export default function JobApplicationsPage() {
  ...
  const [selectedApplicant, setSelectedApplicant] = useState<(Application & { jobs: { title: string; slug: string } | null }) | null>(null);
